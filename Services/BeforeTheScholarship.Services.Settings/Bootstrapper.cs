...
public static class Bootstrapper
{
    ...
    {
        var settings = AppSettings.Load<IdentitySettings>("IdentitySettings", configuration);
    ...
    {
        var settings = AppSettings.Load<SwaggerSettings>("SwaggerSettings", configuration);
        services.AddSingleton(settings!);
